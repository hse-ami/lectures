\section{Лекция 08 от 31.10.2016 \\ Функциональные ряды. Признаки сходимости}
	...
	\begin{proof}
		...
		< C\varepsilon_1+C\varepsilon_1+\eps_1\sum\limits_{n = m+1}^{m+p-1} |b_n(x)-b_{n+1}(x)|=\frac{\varepsilon}{2} + \eps_1\left|b_{m+1}(x) - b_{m+p}(x) \right| \leq \frac{\eps}{2} + 2C\eps_1 \leq \varepsilon.
		\end{multline}
	\end{proof} %% Возможно тут есть чушь. Особенно в конце.
