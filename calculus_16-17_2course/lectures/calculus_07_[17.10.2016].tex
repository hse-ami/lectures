\section{Лекция 07 от 17.10.2016 \\ Функциональные последовательности и ряды}
	...
	\end{Statement}
	\begin{proof} Докажем необходимость. Зафиксируем произвольное $\varepsilon > 0$, положим $\varepsilon_1 = \varepsilon/2$. Тогда
		\begin{gather*}
		...
		И с той же лёгкостью докажем достаточность:
		$$
