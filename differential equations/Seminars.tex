...
Немного про интегрирование. Когда мы интегрируем частную производную, мы делаем эдакое \textit{частное интегрирование}, считая ту переменную, по которой НЕ интегрируем, константой. Кроме того, прямая проверка показывает, что продифференцировав полученную функцию, мы действительно приходим к диффуру из условия. Разберём несколько примеров.

\subsection{Метод интегрального множителя}


\subsubsection{Линейный случай}


\subsubsection{Произвольный случай}
