...
Рассмотрим также изоклину $x = 2t - 4$, $ k = 4$. В данном случае угол наклона касательной будет равен 75 градусов. При этом интегральные кривые будут также стремиться к $x = 2t - 2$, но будучи выпуклыми вверх.
...
\end{task4}
\begin{proof}[Подсказки к решению]
	Проведите исследование, аналогичное \textbf{Примеру №1}. Нарисуйте изоклины и посмотрите направление касательных, проверьте выпуклость, взяв вторую производную. После этого постройте приближение кривой $x(t)$ так, чтобы ваша кривая была параллельна <<чёрточкам>>, соответствующим той изоклине, которую вы пересекли.
\end{proof}
